                ...
                <div className="modal-overlay fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="modal-content bg-white p-8 rounded-lg shadow-lg max-w-sm text-center text-black">
                        ...
                        <div className="mb-4 flex flex-col items-start">
                            <div className='m-2'> 
                                <button className="bg-gray-200 text-black px-4 py-2 rounded hover:bg-gray-300">A. Berlin</button>
                            </div>
                            <div className='m-2'>
                                <button className="bg-gray-200 text-black px-4 py-2 rounded hover:bg-gray-300">B. Madrid</button>
                            </div>
                            <div className='m-2'>
                                <button className="bg-gray-200 text-black px-4 py-2 rounded hover:bg-gray-300">C. Paris</button>
                            </div>
                            <div className='m-2'>
                                <button className="bg-gray-200 text-black px-4 py-2 rounded hover:bg-gray-300">D. Rome</button>
                            </div>
                        </div>
